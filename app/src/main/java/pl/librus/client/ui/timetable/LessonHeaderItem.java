...
public class LessonHeaderItem extends AbstractHeaderItem<LessonHeaderItem.LessonHeaderItemViewHolder> implements Serializable {
    private static final long serialVersionUID = -7280842585284962070L;
    private final LocalDate date;

    public LessonHeaderItem(LocalDate date) {
        this.date = date;
    }
