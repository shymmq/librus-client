...
public class EmptyDayItem extends AbstractSectionableItem<EmptyDayItem.EmptyLessonItemViewHolder, LessonHeaderItem> {

    private final LocalDate date;

    public EmptyDayItem(LessonHeaderItem header, LocalDate date) {
        super(header);
        this.date = date;
    }
